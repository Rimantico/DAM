 ...
 * En este caso encontraremos 4 métodos: Cálculo de nota de asistencia, Cálculo
 * de notatrabajos individuales, Cálculo de nota de trabajos grupales Cálculo de
 * nota de exámenes
 * 
...
public class CalculadoraNota {
	...
	public static void main(String[] args) {
		...
		// En este apartado se definen las variables y donde se introducen los
		...
		do {
			...
			case 3:
				System.out
						.println("Cálculo nota de trabajos individuales(Introduzca 0 para suspenso y 1 para aprobado)");
	 ...
	 * 
	 * opcion -> 1 horasClase->10 horasAsistidas->8 La nota es 1 La nota es 1
	 * 
	 * opcion -> 2 nota1->3 nota2->7 La nota es 0 La nota es 0 nota3->8
	 * 
	 * opcion -> 3 correcto->true La nota es 10 La nota es 10 correcto->false La
	 * nota es 2.5 La nota es 2.5
	 * 
	 * opcion -> 4 nota->5 Aprobado Aprobado nota->3 Suspenso Suspenso
	 */
}
