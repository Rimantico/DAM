...
public class Ejercicio7 {
	 ...
	 * posiciones cada uno, pida valores para ‘vector1’ y ‘vector2’ y calcule
	 * 
	 * @param args
	 */
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < vector3.length; i++) {
			System.out.println("Los " + i + " primeros valores de los vectores 1 y 2 son " + vector1[i] + " y "
					+ vector2[i] + ". El total de su suma es " + (vector1[i] + vector2[i]));
		}
