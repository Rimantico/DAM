	...
	public static void main(String[] args) {
		...
		for(int i = 0 ; i <ventasSucursales.length  ;i++)
			for(int j = 0 ;j<ventasSucursales[i].length ; j++) {
				System.out.println("¿Cuantos productos hemos vendido en la " + (i+1) +"º sucursal sobre el " + (j+1) +"º producto?: ");
		...
		System.out.println("La sucursal con mayor recaudación es la " +(sucursalMax + 1) + " con una recaudación de " + maxRecaudacion);
